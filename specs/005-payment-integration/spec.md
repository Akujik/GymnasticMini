...
### 钱包充值记录跟踪 (FR-025~FR-027)

- **FR-025**: 系统必须在支付成功后更新用户钱包的last_recharge_amount为最新充值金额
- **FR-026**: 系统必须在支付成功后更新用户钱包的last_recharge_date为当前时间
- **FR-027**: 系统必须支持最低充值金额2700元的验证规则，确保充值金额符合业务要求
