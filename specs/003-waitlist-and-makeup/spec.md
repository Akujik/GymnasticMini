...
- **FR-007**: RuoYi系统必须在用户申请加入候补时检查钱包冻结状态,冻结状态下禁止加入候补
- **FR-008**: RuoYi系统必须在候补用户收到候补通知时检查冻结状态,冻结状态下不允许确认预约
- **FR-009**: RuoYi系统必须支持候补用户在冻结期间查看候补状态,但无法进行任何预约操作
- **FR-010**: RuoYi系统必须在冻结状态解除后恢复用户的候补权限
