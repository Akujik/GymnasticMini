...
class AdminActivityBiz extends BaseBiz {
  static initFormData(id = "") {
    ...
    return {
      ...
      formJoinForms: formSetHelper.initFields(
        projectSetting.ACTIVITY_JOIN_FIELDS
      ),
    };
  }
...
AdminActivityBiz.CHECK_FORM = {
  ...
  shopId: "formShopId|must|string|name=店铺",

  maxCnt: "formMaxCnt|must|int|name=人数上限",
  start: "formStart|must|string|name=课程开始时间",
  end: "formEnd|must|string|name=课程结束时间",
