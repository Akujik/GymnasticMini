...
const AdminShopService=require('../../service/admin/admin_shop_service')
...
class AdminActivityController extends BaseProjectAdminController {
    ...
    async getAdminActivityList() {
        ...
        let rules = {
            ...
            size: 'int|defalut=1000',
            isTotal: 'bool',
            oldTotal: 'int',
            shopId: 'string|name=店铺ID',
        };
    ...
    async insertActivity() {
        ...
        let rules = {
            ...
            start: 'must|string|name=课程开始时间',
            end: 'must|string|name=课程结束时间',
            ...
            shopId:'must|String|name=门店',
            shopName:'must|string|name=店铺名称',
        };
...
//
        ...
        this.logOther('添加了课程《' + input.title + '》');
