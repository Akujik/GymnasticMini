...
class BaseProjectService extends BaseService {
	...
	async initSetup() {
		...
		const COLLECTIONS = ['setup', 'admin', 'log', 'news', 'activity', 'activity_join', 'comment', 'fav', 'user', 'pay','shop'];
		const CONST_PIC = '/images/cover.gif';


		const NEWS_CATE = '1=活动公告';
		const ACTIVITY_CATE = '1=体操,2=体适能,3=跳绳,4=体考达标';
