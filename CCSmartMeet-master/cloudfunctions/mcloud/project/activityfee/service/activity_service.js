...
class ActivityService extends BaseProjectService {
    ...
    shopId
		...
		let fields = 'ACTIVITY_START_MONTH,ACTIVITY_END_MONTH,ACTIVITY_START_DAY,ACTIVITY_END_DAY,ACTIVITY_USER_LIST,ACTIVITY_STOP,ACTIVITY_JOIN_CNT,ACTIVITY_OBJ,ACTIVITY_VIEW_CNT,ACTIVITY_TITLE,ACTIVITY_MAX_CNT,ACTIVITY_START,ACTIVITY_END,ACTIVITY_ORDER,ACTIVITY_STATUS,ACTIVITY_CATE_NAME,ACTIVITY_OBJ,ACTIVITY_SHOP_ID,ACTIVITY_SHOP_NAME';
    ...
    //} where.and.ACTIVITY_CATE_ID = cateId;
  
    if (util.isDefined(shopId) &&  shopId ) {
      where.and.ACTIVITY_SHOP_ID = ['inin',`${shopId},-1`] 
    }
		...
		if (util.isDefined(search) && search) {
          ...
          Object.assign(where.and,
            {
              ACTIVITY_CATE_ID : ['inin',`${String(sortVal)},-1`] ,
    ...
    //console.log('activity where ' , where);
